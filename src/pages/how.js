      ...
      <Main className={classes.root}>
        <Secuence stagger>
          <article>
            ...
            <p><Fader>Being able to build our components is hard enough: but how can we actually do it? For our probes to create probes of their own, they need to create extremely advanced components: Solar sails 400 atoms thick, computer parts which take an entire chip foundry to build. How can they do this without dragging an entire planet of industry with them? Past proposed probes could only replicate 70% of mass and none of the key components like CPUs. But today, we've solved this problem. The answer is the same thing that's been curing your cancer and providing you with free food for the last three years: molecular nanotechnology.</Fader></p>
